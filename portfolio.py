...
PORTFOLIO = [
    {
        ...
        "t1_sell_date": "2026-09-08",     # Datum von Teilverkauf 1 (z. B. '2026-07-15')
        "t1_sell_price": 25.58,    # Tatsächlicher Verkaufskurs von T1 (Optional: Falls leer, wird der EMA50 genutzt)
    ...
    },
    {
        ...
        "shares": 42,
        "sold": False,
        "dip_score_bei_kauf": 69.2,   # zur Dokumentation, wird aber NICHT automatisch zu "soft"
        "signal_stufe": "soft",       # das ist der Eintrag, der tatsächlich zählt
    },
]
